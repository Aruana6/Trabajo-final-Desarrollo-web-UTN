document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#formularioCotizacion').validate({
        rules: {
            nombreCotizacion: 'required',
            precio: 'required',
            cantidad: 'required'
        },
        messages: {
            nombreCotizacion: 'Por favor ingrese su nombre',
            precio: 'Por favor ingrese el precio',
            cantidad: 'Por favor ingrese la cantidad'
        },
        submitHandler: function(form) {
            // Obtener los valores de los campos del formulario
            var nombre = document.getElementById('nombreCotizacion').value;
            ...
            downloadLink.download = 'formulario_cotizacion.pdf';
            downloadLink.click();
